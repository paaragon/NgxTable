(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/forms'), require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('@fortawesome/free-solid-svg-icons'), require('@fortawesome/angular-fontawesome')) :
    typeof define === 'function' && define.amd ? define('@paaragon/ngx-table', ['exports', '@angular/common', '@angular/forms', 'rxjs', 'rxjs/operators', '@angular/core', '@fortawesome/free-solid-svg-icons', '@fortawesome/angular-fontawesome'], factory) :
    (factory((global.paaragon = global.paaragon || {}, global.paaragon['ngx-table'] = {}),global.ng.common,global.ng.forms,global.rxjs,global.rxjs.operators,global.ng.core,global.freeSolidSvgIcons,global.angularFontawesome));
}(this, (function (exports,common,forms,rxjs,operators,core,freeSolidSvgIcons,angularFontawesome) { 'use strict';
    ...
    var NgxTableComponent = /** @class */ (function () {
        ...
        Object.defineProperty(NgxTableComponent.prototype, "data", {
            get: /**
             * @return {?}
             */ function () {
                return this.content;
        ...
        Object.defineProperty(NgxTableComponent.prototype, "config", {
            get: /**
             * @return {?}
             */ function () {
         ...
         * @return {?}
         */
        NgxTableComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
            };
         ...
         * @return {?}
         */
        NgxTableComponent.prototype.onOrder = /**
         * @param {?} orderObj
         * @return {?}
         */
            function (orderObj) {
         ...
         * @return {?}
         */
        NgxTableComponent.prototype.onFilter = /**
         * @param {?} filterObj
         * @return {?}
         */
            function (filterObj) {
         ...
         * @return {?}
         */
        NgxTableComponent.prototype.onCreate = /**
         * @param {?} newObj
         * @return {?}
         */
            function (newObj) {
         ...
         * @return {?}
         */
        NgxTableComponent.prototype.enableFilter = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        NgxTableComponent.prototype.enableCreate = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        NgxTableComponent.prototype.enableBody = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        NgxTableComponent.prototype.getHeadersFromData = /**
         * @private
         * @param {?} data
         * @return {?}
         */
        ...
        NgxTableComponent.decorators = [
            { type: core.Component, args: [{
                        selector: 'ngx-table',
                        template: "<div class=\"table-responsive\">\n  <table class=\"table\">\n    <thead>\n      <tr ngx-table-header [humanHeaders]=\"humanHeaders\" [headers]=\"headers\" (order)=\"onOrder($event)\" [config]=\"mergedConfig\"></tr>\n      <tr ngx-table-filter *ngIf=\"enableFilter()\" [headers]=\"headers\" [config]=\"mergedConfig\" (filter)=\"onFilter($event)\">\n      </tr>\n      <tr ngx-table-create *ngIf=\"enableCreate()\" [headers]=\"headers\" [config]=\"mergedConfig\" (create)=\"onCreate($event)\">\n      </tr>\n    </thead>\n    <tbody ngx-table-body [data]=\"content\" [headers]=\"headers\" *ngIf=\"enableBody()\" [config]=\"mergedConfig\"></tbody>\n  </table>\n</div>\n<div class=\"row\" *ngIf=\"!enableBody()\">\n  <div class=\"container-fluid\">\n    <div class=\"col-xs\">\n      <div class=\"alert alert-warning\" role=\"alert\">\n        No data available\n      </div>\n    </div>\n  </div>\n</div>\n",
    ...
    var NgxTableHeaderComponent = /** @class */ (function () {
        function NgxTableHeaderComponent() {
            this.faHashtag = freeSolidSvgIcons.faHashtag;
            this.faCaretDown = freeSolidSvgIcons.faCaretDown;
            this.faCaretUp = freeSolidSvgIcons.faCaretUp;
            this.headers = [];
            this.order = new core.EventEmitter();
        }
        /**
    ...
    ***************************************************************************** */
    ...
    var NgxTableFilterComponent = /** @class */ (function () {
        function NgxTableFilterComponent() {
            this.faFilter = freeSolidSvgIcons.faFilter;
            this.sub = null;
            this.filters = {};
            this.errors = {};
            this.filter = new core.EventEmitter();
         ...
         */
            function () {
                ...
                try {
                    for (var _b = __values(this.headers), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var header = _c.value;
                        this.filters[header] = {
                            operator: null,
                            value: null
         ...
         */
            function () {
                ...
                this.sub = this.debouncer
                    .pipe(operators.debounceTime(this.config.filter.debounceTime))
                    .subscribe(( /**
             * @param {?} val
             * @return {?}
             */function (val) {
    ...
    exports.ɵb = NgxTableBodyComponent;
    exports.ɵd = NgxTableCreateComponent;
    exports.ɵc = NgxTableFilterComponent;
    exports.ɵa = NgxTableHeaderComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=paaragon-ngx-table.umd.js.map